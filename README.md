...
* \[2023/9/25] 更新[Qwen](https://github.com/QwenLM/Qwen) ⭐ 21,687 | 🐛 38 | 🌐 Python | 📅 2026-03-05，新增Qwen-14B和Qwen-14B-Chat模型，并更新Qwen-7B和Qwen-7B-Chat模型。相比原版Qwen-7B，新版使用更多训练数据 (2.4T token)，序列长度从2048扩展至8192。整体中文能力以及代码能力提升较多。
...
|         [Qwen](https://github.com/QwenLM/Qwen) ⭐ 21,687 \| 🐛 38 \| 🌐 Python \| 📅 2026-03-05         | 1.8B/1.8B-Chat <br> 7B/7B-Chat <br> 14B/14B-Chat <br> 72B/72B-Chat |                             [阿里云](https://qianwen.aliyun.com/)                            |                                    [paper](https://arxiv.org/abs/2309.16609)                                   |
...
* [MedicalGPT](https://github.com/shibing624/MedicalGPT) ⭐ 5,771 | 🐛 6 | 🌐 Python | 📅 2026-06-03
...
* [Lawyer LLaMA](https://github.com/AndrewZhe/lawyer-llama) ⭐ 1,000 | 🐛 38 | 🌐 Python | 📅 2024-08-28
...
* [FinanceBench](https://github.com/patronus-ai/financebench) ⭐ 355 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2024-12-03
...
* [FinEval](https://github.com/SUFE-AIFLM-Lab/FinEval) ⭐ 285 | 🐛 5 | 🌐 Python | 📅 2025-06-23
...
* [MMCU](https://github.com/Felixgithub2017/MMCU) ⭐ 90 | 🐛 10 | 🌐 Python | 📅 2024-03-24
